...
Eigenvalues becomes larger when the number of observations is smaller,
...
matplot(sDevs, type = 'l', xlab="Eigenvalues", ylab="size", cex.lab=2.5, cex.main=1.5, cex.axis=2, lwd=2)
legend(x="topright", legend=c("PCA", "PPCA", "BPCA", "SVDimpute","Nipals PCA"), lty=1:5, col=1:5, cex=2.5, lwd=2)
@
