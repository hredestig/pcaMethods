...
##
## The function contains the actual implementation of the BPCA component 
## estimation. It performs one step of the BPCA EM algorithm.
## It is called 'maxStep' times from within the main loop in BPCAestimate.
##
## Parameters:
## M        - Data structure containing all needed information
##            See the source documentation of BPCA_initmodel for details
## y        - Numeric original data matrix
##
## Return values:
## M        - Updated version of the data structure
##
